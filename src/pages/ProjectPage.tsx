...
export default function ProjectPage() {
  ...
  const translatedProjectLinks: TranslatedLink[] = projectLinks.map(
    (link: LinkItem) => ({
      url: link.url,
  ...
  const translatedGitLinks: TranslatedLink[] = gitLinks.map(
    (link: LinkItem) => ({
      url: link.url,
      name: link.nameKey ? t(link.nameKey) : link.defaultName,
    }),
          ...
          <div className="projectsPageMain-left">
            ...
            <div>
              ...
              <div className="projectsPageMain-left--links">
                {translatedProjectLinks.map(
                  (link: TranslatedLink, index: number) => (
                    <a
                      key={`project-${index}`}
                      href={link.url}
