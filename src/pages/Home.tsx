...
// Importing logos
import LOGO_ACCENTURE_URL from '../assets/img/experience/accenture.jpg';
import LOGO_UNIVERSAE_URL from '../assets/img/experience/universae.png';
import LOGO_I2C_URL from '../assets/img/experience/i2c.png';
          ...
          <div className='homeMain-left'>
            ...
            <div>
              ...
              <div className="button-group">
                ...
                <a href={brianResume} className='custom-button-sec resume-button' target="_blank" rel="noopener noreferrer">{t('About.resume')}</a>
              </div>
            </div>
          </div>
