            ...
            <section className='home'>
                ...
                <main className='homeMain'>
                    <div className='homeMain-left'>
                        <div>
                            <h1>Web Developer</h1>
                            <p>I'm Brian, a frontend developer passionate about web design & learning and building new experiences.</p>
                        </div>
                        <div>
                            <ul>
                            ...
                            <a href="mailto:brianglezn@gmail.com" className='custom-button'>Contact</a>
                        </div>
                    </div>
                ...
                <section className="homeProjects">
                    ...
                    <a href="/projects" className=''>--View all</a>
                </section>
